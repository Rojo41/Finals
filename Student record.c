...
int main()
{
    ...
    {
        printf("\n========================================================================================================================");
        printf("\n=====================================Welcome to Casisang National Highschool============================================");
        printf("\n========================================================================================================================\n");
        printf("\n\t\t\t\t\t\t[1]Student\n");
        printf("\t\t\t\t\t\t[2]Teacher\n");
        printf("\t\t\t\t\t\t [0]Exit\n");
...
void create()
{
    ...
    int n, i, j, result = 0, temp;
    printf("How many Students(-1 to back): ");
    scanf("%d", &n);
    if(n == -1){
            system("cls");
        SelTeacher();
    ...
    //ang fp gi declare as file open sa studentdata.txt nga file gamit ang append mode
...
void Register()
{
    ...
    char user[20], pass[20], username[20], password[20], conpass[20];
    int result = 0;
    printf("\nEnter Username: ");
    scanf("%s", user);
    ...
    {
        printf("Password did not Matched, Please Try Again");
    }
    fclose(fp);
}
void Login()
